...
Reconstruction::Reconstruction(const std::string &id,
                               ...
                               std::shared_ptr<ReconstructionAgent> reconstruction_agent) : _id(id),
...
SparseReconstruction::SparseReconstruction(const std::string &id, std::shared_ptr<SparseStorageAdapter> storage_adapter) : _id(id),
