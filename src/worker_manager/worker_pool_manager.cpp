...
Status worker_scope(const std::string &f_name, T f, unsigned int max_retry, int num_cores = 1)
{
    ...
    try
    {
        ...
        Status status;
        ExpotentialBackoff(
            f_name, [worker, &f, &status, worker_address]() mutable {
...
class WorkerPoolManagerServer : public WorkerPoolManager::Service
{
                                   ...
                                   WorkerComputeFeaturesResponse *response)
    {
        ...
        return worker_scope(
            "ComputeFeatures", [request, response](grpc::ClientContext &ctx, std::shared_ptr<Worker::Stub> worker) mutable {
                                  ...
                                  WorkerComputeMatchesResponse *response)
    {
        ...
        return worker_scope(
            "ComputeMatches", [request, response](grpc::ClientContext &ctx, std::shared_ptr<Worker::Stub> worker) mutable {
                            ...
                            WorkerAddImageResponse *response)
    {
        ...
        return worker_scope(
            "AddImage", [request, response](grpc::ClientContext &ctx, std::shared_ptr<Worker::Stub> worker) mutable {
                                  ...
                                  WorkerIncrementalSFMResponse *response)
    {
        ...
        return worker_scope(
            "IncrementalSFM", [request, response](grpc::ClientContext &ctx, std::shared_ptr<Worker::Stub> worker) mutable {
                                    ...
                                    WorkerComputeStructureResponse *response)
    {
        ...
        return worker_scope(
            "ComputeStructure", [request, response](grpc::ClientContext &ctx, std::shared_ptr<Worker::Stub> worker) mutable {
