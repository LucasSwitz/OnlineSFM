...
_RECONSTRUCTIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='ScoreImages',
    full_name='ReconstructionService.ScoreImages',
    index=19,
    containing_service=None,
