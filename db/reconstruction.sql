...
CREATE TABLE IF NOT EXISTS OPENMVG_VIEWS(
    ...
    DATA JSON NOT NULL,
    (RECONSTRUCTION_ID, VIEW_IDX) PRIMARY KEY
);
CREATE TABLE IF NOT EXISTS OPENMVG_INTRINSICS(
    ...
    DATA_HASH BIGINT,
    DATA JSON NOT NULL,
    (RECONSTRUCTION_ID, INTRINSICS_IDX) PRIMARY KEY
);
CREATE TABLE IF NOT EXISTS OPENMVG_MATCHES(
    RECONSTRUCTION_ID CHAR(36) NOT NULL REFERENCES RECONSTRUCTIONS,
    VIEW_1 BIGINT,
    VIEW_2 BIGINT,
    GEOMETRIC_MODEL CHAR(1),
    MATCH_DATA BLOB NOT NULL,
    (RECONSTRUCTION_ID, VIEW_1, VIEW_2) PRIMARY KEY
);
CREATE TABLE IF NOT EXISTS OPENMVG_POSES(
    RECONSTRUCTION_ID CHAR(36) NOT NULL REFERENCES RECONSTRUCTIONS,
    POSE_IDX BIGINT NOT NULL,
    DATA JSON NOT NULL,
    (RECONSTRUCTION_ID, POSE_IDX) PRIMARY KEY
);
